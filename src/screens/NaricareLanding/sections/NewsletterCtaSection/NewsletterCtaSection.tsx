...
const decorativeElements = [
  {
    className: "absolute left-[6%] bottom-[-10%] w-[198px] h-[231px] filter grayscale",
    alt: "Group",
    src: "/group-1.svg",
  },
  {
    className: "absolute top-[47%] left-[75%] w-[213px] h-[231px] filter grayscale",
    alt: "Group",
    src: "/group-2.svg",
  },
  {
    className: "absolute top-[70%] left-[14%] w-[23px] h-8",
    alt: "Vector",
    src: "/vector-6.svg",
  },
  {
    className: "absolute top-[41%] left-[84%] w-[54px] h-[78px]",
    alt: "Group",
    src: "/group-36696.png",
  },
];
