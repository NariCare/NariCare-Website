...
import { getFeaturedArticles, getCategoryById } from "../../../../data/blogData";

const featuredPosts = getFeaturedArticles().slice(0, 3);

export const BlogSection = (): JSX.Element => {
  return (
    <section id="resources" className="flex flex-col w-full items-center gap-8 md:gap-16 px-0 py-12 lg:py-16 relative bg-gray-50">
